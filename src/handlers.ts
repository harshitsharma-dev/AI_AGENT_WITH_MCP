...
export class ToolHandlers {
    ...
    async handleListTools(): Promise<Tool[]> {
        ...
        try {
            ...
            console.log('DEBUG: handleCallTool called with params:', JSON.stringify(params, null, 2));
            console.log('DEBUG: params.name =', params.name, '(type:', typeof params.name, ')');
            console.log('DEBUG: params.arguments =', params.arguments);
            ...
            console.log('DEBUG: Error in handleCallTool:', error);
            console.log('DEBUG: Error details - params.name:', params.name, 'params.arguments:', params.arguments);
            return {
                content: [{
                    type: 'text',
                    text: JSON.stringify({
        ...
        try {
            // Debug logging to identify the tool name issue
            console.log('DEBUG: handle() called with toolName:', JSON.stringify(toolName), '(type:', typeof toolName, ')');
            console.log('DEBUG: Available tools:', Object.values(API_TOOLS));
            ...
            switch (toolName) {
                ...
                default:
                    console.log('DEBUG: Unknown tool name received:', JSON.stringify(toolName), 'Available tools:', Object.values(API_TOOLS));
